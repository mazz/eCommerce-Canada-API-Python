...
from TLSConnector import TLS1_2Handler

urllib.request.install_opener(urllib.request.build_opener(TLS1_2Handler()))
...
req = mpgClasses.mpgHttpsPost("esqa.moneris.com", "monca01494", "XKXqi9P0q7bx7bE3DzaO", p)
req.postRequest()
